...
from app.routes import (
    alerts, audit, auth, cache, chat, connections, context, health, optimization,
    performance, schema, sql, workarounds,
)
...
TAGS_METADATA = [
    ...
    {"name": "alerts", "description": "Alertas por umbrales sobre métricas + auto-remediación dirigida."},
]
